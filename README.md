...
La programación incluye horarios mediante el elemento semántico `time`, permitiendo representar de manera adecuada la información temporal.

## Decisiones de diseño del caso 2

El caso 2 fue diseñado con un enfoque de consulta móvil.

A diferencia del centro de control del caso 1, esta interfaz prioriza inicialmente una lectura vertical sencilla. Conforme aumenta el ancho disponible, las actividades, espacios y servicios se distribuyen en más columnas.

El encabezado y la navegación permanecen disponibles mediante posicionamiento `sticky`. La navegación horizontal permite acceder rápidamente a las distintas secciones del festival.

CSS Grid se utiliza para reorganizar diferentes agrupaciones de contenido según el ancho disponible, mientras que Flexbox se emplea para estructuras unidimensionales como la programación y elementos de navegación.
...
- `h3` identifica contenidos internos como actividades, misiones, equipos, espacios o servicios.
...
En el caso 2 permite reorganizar agrupaciones como actividades, espacios y servicios conforme aumenta el ancho disponible.

Las columnas y áreas cambian según el espacio disponible, permitiendo que cada interfaz responda a su contexto.
...
En teléfono se prioriza una lectura principalmente vertical. En tableta se incorporan nuevas columnas cuando existe espacio suficiente y en escritorio se aprovecha el ancho para mostrar más información simultáneamente.
...
En el caso 2 aumenta la cantidad de columnas disponibles para actividades, espacios y servicios, y el contenido principal aprovecha de manera diferente el espacio de escritorio.
...
La siguiente tabla registra el desarrollo progresivo del proyecto y corresponde al historial de Git existente al momento de esta actualización.
...
| 2 | 2026-09-19 | `412740e` | agrega contenido y estilos base del caso 1 | Caso 1 | Incorporación del contenido y estilos iniciales del centro de control. |
...
| 4 | 2026-09-20 | `24f72bf` | crea interfaz responsive del festival cultural | Caso 2 | Desarrollo de la interfaz responsive del festival. |
| 5 | 2026-09-20 | `446d860` | mejora posicionamiento y navegacion del caso 2 | Caso 2 | Mejoras de posicionamiento y navegación. |
...
| 7 | 2026-09-20 | `5f8d702` | Documenta Estructura y Decisiones de Diseño | Documentación | Incorporación de estructura y decisiones de diseño al README. |
| 8 | 2026-09-20 | `a83dedd` | Update README.md | Documentación | Actualización del archivo README. |
| 9 | 2026-09-20 | `256b14a` | Update README.md | Documentación | Actualización adicional del archivo README. |
| 10 | 2026-09-20 | `0442aef` | corrige redaccion y documentacion del proyecto | Documentación | Corrección de redacción y documentación general. |
...
| 12 | 2026-09-20 | `b559cb8` | mejora semantica de horarios del caso 2 | Caso 2 | Incorporación de elementos `time` en los horarios de actividades actuales. |

Para consultar el historial directamente desde Git se puede utilizar:
